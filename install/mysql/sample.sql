...
INSERT INTO `contacts` (`contacts_contact_id`, `name`, `slug`, `position`, `address`, `suburb`, `state`, `country`, `postcode`, `telephone`, `fax`, `misc`, `image`, `email_to`, `published`, `created_by`, `created_on`, `modified_by`, `modified_on`, `locked_by`, `locked_on`, `ordering`, `params`, `categories_category_id`, `access`, `mobile`)
  VALUES
  (1, 'Dolor Sit', 'dolor-sit', 'Porta Ornare', 'Fermentum 1', 'Condimentum', 'Lorem', 'Pharetra', '61803', '161803', '618', '<p>Morbi leo risus, porta ac consectetur ac, vestibulum at eros.</p>', NULL, 'dolor@pellentesque.com', 1, 1, NULL, NULL, NULL, NULL, NULL, 1, 'show_email=\"0\"\nshow_email_form=\"1\"\nallow_vcard=\"0\"', 3, 0, '39887');
