...
class DispatcherHttp extends DispatcherAbstract implements ObjectInstantiable, ObjectMultiton
{
     ...
     */
    public function authenticateRequest(Command $context)
    {
     ...
     */
    public function signResponse(Command $context)
    {
     ...
     * @return	mixed
     */
	protected function _actionDispatch(Command $context)
	{
     ...
     * @param Command $context   A command context object
     */
    protected function _actionRedirect(Command $context)
    {
        $url = $context->param;
     ...
     */
    protected function _actionGet(Command $context)
    {
     ...
     * @return 	DatabaseRow(Set)Interface	A row(set) object containing the modified data
     */
    protected function _actionPost(Command $context)
    {
        $action     = null;
        $controller = $this->getController();
     ...
     */
    protected function _actionPut(Command $context)
    {
        $action     = null;
        $controller = $this->getController();
     ...
     * @return 	DatabaseRow(Set)Interface	A row(set) object containing the modified data
     */
    protected function _actionDelete(Command $context)
    {
        $controller = $this->getController();
     ...
     */
    protected function _actionOptions(Command $context)
    {
        $methods = array();
