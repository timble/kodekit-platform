...
class JElementFolders extends JElement
{
	...
	function fetchElement($name, $value, &$node = null, $control_name = null, $show_root = true)
	{
		...
		$tree =  Library\ObjectManager::getInstance()->get('com:files.controller.folder')
		...
		return  Library\ObjectManager::getInstance()->get('com:files.template.helper.select')->optionlist(array(
			'name' => $el_name,
			'options' => $options,
			'showroot' => false,
