...
<div class="scopebar">
	...
	<div class="scopebar__group">
		<a class="<?= (parameter('direction') == 'desc') ? 'active' : ''; ?>" href="<?= route(parameter('direction') == 'desc' ? 'direction=' : 'direction=desc' ) ?>">
		    <?= translate('Latest First') ?>
		</a>
		<a class="<?= (parameter('direction') == 'asc') ? 'active' : ''; ?>" href="<?= route(parameter('direction') == 'asc' ? 'direction=' : 'direction=asc' ) ?>">
