...
{
    protected function _beforeRead(Library\Command $context)
    {
    ...
    protected function _afterToken(Library\Command $context)
    {
        $user = $context->user;
        if (!$context->result)
        {
    ...
    protected function _afterReset(Library\Command $context)
    {
        if ($context->result)
        {
