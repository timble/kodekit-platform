...
{
    protected function _beforeRead(Library\CommandContext $context)
    {
    ...
    protected function _afterToken(Library\CommandContext $context)
    {
        $user = $context->user;
        if (!$context->result)
        {
    ...
    protected function _afterReset(Library\CommandContext $context)
    {
        if ($context->result)
        {
