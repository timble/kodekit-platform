...
<form method="post" action="" class="-koowa-form form-horizontal">
    ...
    <fieldset>
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <?= @template('com:articles.view.article.default_categories.html', array('categories' =>  @object('com:articles.model.categories')->sort('title')->table('articles')->getRowset(), 'article' => $article)) ?>
            </div>
        </div>
    </fieldset>
</form>