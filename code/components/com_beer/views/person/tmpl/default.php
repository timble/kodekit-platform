...
<div id="beer_header">
	...
	<h2 id="beer_position"><a href="<?= @route('index.php?option=com_beer&amp;view=department&id=' . @$person->beer_department_id) ; ?>" ><?= @$person->department; ?></a></h2>
	<h2 id="beer_position"><a href="<?= @route('index.php?option=com_beer&amp;view=office&id=' . @$person->beer_office_id) ; ?>" ><?= @$person->office; ?></a></h2>
	<div class="clr"></div>
</div>
<div id="beer_info">
	...
	<span class="vcard"><a href="<?=@route('option=com_beer&view=person&format=vcard&id='.@$person->id) ?>" /><?= @text('VCard'); ?></a></span>
	</div>
<div id="beer_desc">
	<h2><?= @text('Bio'); ?></h2>
	<?= @$person->bio; ?>
