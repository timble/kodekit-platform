...
<div id="beer_header">
	...
	<h2 id="beer_position"><a href="<?= @route('view=department&id=' . @$person->department_slug) ; ?>" ><?= @$person->department; ?></a></h2>
...
<div id="beer_info">
	...
	<span class="vcard"><a href="<?=@route('view=person&format=vcard&id='.@$person->slug) ?>" /><?= @text('VCard'); ?></a></span>
	</div>
<div id="beer_desc">
	<h2><?= @text('Bio'); ?></h2>
	<?= @$person->bio; ?>
