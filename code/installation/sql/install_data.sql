...
INSERT INTO `#__users` (`users_user_id`, `name`, `email`, `enabled`, `send_email`, `users_role_id`, `registered_on`, `last_visited_on`, `created_by`, `created_on`, `modified_by`, `modified_on`, `locked_by`, `locked_on`, `activation`, `params`, `uuid`)
VALUES
