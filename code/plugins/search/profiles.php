...
JPlugin::loadLanguage( 'plg_search_profiles' );
...
function plgSearchProfiles( $text, $phrase='', $ordering='', $areas=null )
{
	...
	// load plugin params info
 	$pluginParams = new JParameter( JPluginHelper::getPlugin('search', 'profiles')->params );
	...
	$list = KFactory::get('admin::com.profiles.model.people')
		->set('search', $text)
		->set('enabled', 1)
	...
	foreach($list as $k => $item)
	{
		...
		$results[$k]->href 		= 'index.php?option=com_profiles&view=person&id='.$item->slug;
