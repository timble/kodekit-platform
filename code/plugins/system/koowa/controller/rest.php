...
{	
	...
	{
		return KInflector::isPlural($view) ? parent::executeBrowse() : parent::executeRead();
	}
	...
	public function executePost()
	{
		...
		return (!$id && !count($cid)) ? parent::executeAdd() : parent::executeEdit();
	}
