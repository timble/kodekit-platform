...
var Editors = new Hash, Editor = new Class({
	...
	pre_wpautop : function(content) {
		...
		document.getElement('body').fireEvent('beforePreWpautop', [o]);
		o.data = t._wp_Nop(o.data);
		document.getElement('body').fireEvent('afterPreWpautop', [o]);
		return o.data;
	},
	...
	wpautop : function(pee) {
		...
		document.getElement('body').fireEvent('beforeWpautop', [o]);
		o.data = t._wp_Autop(o.data);
		document.getElement('body').fireEvent('afterWpautop', [o]);
		return o.data;
	},
