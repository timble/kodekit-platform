...
class ComApplicationViewHtml extends KViewHtml
{
    public function __construct(KConfig $config)
    {
        ...
        $this->getTemplate()->getFilter('alias')->addAlias(
            array($this->_mediaurl.'/application/' => (string) KRequest::base().'/site/template/'.$this->getService('application')->getTemplate().'/'), KTemplateFilter::MODE_READ | KTemplateFilter::MODE_WRITE
        );
    }
