...
<ul id="menu">
    <li><a href="<?= @route('option=com_dashboard&view=dashboard') ?>"><?= @text('Dashboard') ?></a></li>
    <? if($user->authorize('com_menus', 'manage')) : ?> 
        <li><a href="<?= @route('option=com_pages&view=pages') ?>"><?= @text('Pages') ?></a></li>
    <? endif ?>
    ...
    <li><a href="<?= @route('option=com_files&view=files') ?>"><?= @text('Files') ?></a></li>
    <? if($user->authorize('com_users', 'manage')) : ?>
        <li><a href="<?= @route('option=com_users&view=users') ?>"><?= @text('Users') ?></a></li>
    <? endif ?>
