...
<link href="templates/<?php echo  $this->template ?>/css/960_<?php echo $this->params->get('gridType'); ?>.css" rel="stylesheet" type="text/css" media="screen and (min-width:1025px)" />
<link href="templates/tablet/css/960_<?php echo $this->params->get('gridType'); ?>.css" rel="stylesheet" type="text/css" media="screen and (max-width: 1024px)" />
...
<body id="minwidth-body" class="<?php echo JRequest::getVar('option', 'cmd'); ?>" >
	...
	<div id="content-box">
		<div id="element-box" class="container_12 <?php echo (JRequest::getInt('hidemainmenu')) ? 'form' : 'default' ?> clearfix">
