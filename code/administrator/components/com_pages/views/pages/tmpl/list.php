...
<? foreach($this->getService('com://admin/pages.model.menus')->sort('title')->getList() as $menu) : ?>
    <? $menu_pages = $this->getService('com://admin/pages.model.pages')->getList()->find(array('pages_menu_id' => $menu->id)) ?>
    <? if(count($menu_pages)) : ?>
