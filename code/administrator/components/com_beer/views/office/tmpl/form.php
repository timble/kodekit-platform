	...
	<div style="width:100%; float: left" id="mainform">
		...
		<fieldset>
			<legend><?= @text('Location'); ?></legend>
				...
				<?=@helper('admin::com.beer.helper.iso.country', 'country', @$office->country, 'country', '', '', true) ?>
				<br />
				...
				<div id="statecontainer"><?=@helper('admin::com.beer.helper.iso.states', @$office->country, 'state', @$office->state) ?></div>
				<br />
